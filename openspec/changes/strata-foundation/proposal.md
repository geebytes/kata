...
- Add structured role protocols for planning, implementation, review, judging, and distillation with bounded write scopes; model selection stays with the host platform.
...
- `model-policy-and-evidence`: role write scopes, evidence envelopes, Reviewer/Judge contracts, and bounded repair loops.

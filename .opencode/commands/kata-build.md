---
description: Run the kata-build Kata workflow
---

Equivalent Kata skill: `kata-build`
Command name: `/kata-build`
...
```bash
kata-cli build --change <change-id>
```

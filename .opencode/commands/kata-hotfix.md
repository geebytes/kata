---
description: Run the kata-hotfix Kata workflow
---

Equivalent Kata skill: `kata-hotfix`
Command name: `/kata-hotfix`
...
```bash
kata-cli hotfix --change <change-id> --isolation <mode> --development <mode> --review <mode>
```
...
Before running `kata-cli hotfix`, resolve these three choices in the agent conversation:

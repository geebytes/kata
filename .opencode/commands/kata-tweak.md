...
```bash
kata tweak --change <change-id> --isolation <mode> --development <mode> --review <mode>
```
...
Before running `kata tweak`, resolve these three choices in the agent conversation:

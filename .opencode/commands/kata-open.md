---
description: Run the kata-open Kata workflow
---

Equivalent Kata skill: `kata-open`
Command name: `/kata-open`
...
```bash
kata-cli open --change <change-id> --isolation <mode> --development <mode> --review <mode>
```
...
Before running `kata-cli open`, resolve these three choices in the agent conversation:

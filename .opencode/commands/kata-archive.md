---
description: Run the kata-archive Kata workflow
---

Equivalent Kata skill: `kata-archive`
Command name: `/kata-archive`
...
```bash
kata-cli archive --change <change-id>
```

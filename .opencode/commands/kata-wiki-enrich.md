---
description: Run the kata-wiki-enrich Kata workflow
---

Equivalent Kata skill: `kata-wiki-enrich`
Command name: `/kata-wiki-enrich`
...
```bash
kata-cli wiki task --kind enrich
```
